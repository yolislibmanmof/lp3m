...
// --- INFO KONTAK DINAMIS (dari Admin > Kontak & FAQ) ---
$fc = null;
...
<head>
    ...
    <style>
        ...
        @keyframes brandPulse { 0%,100% { box-shadow: 0 0 0 4px var(--gold-soft), 0 0 10px rgba(217,164,65,0.6); } 50% { box-shadow: 0 0 0 6px var(--gold-soft), 0 0 18px rgba(217,164,65,0.9); } }
        ...
        .splash-tag { font-size: 11px; font-weight: 800; letter-spacing: 0.3em; color: rgba(255,255,255,0.8); text-transform: uppercase; animation: fadeUp 0.8s 0.3s both; position: relative; z-index: 1; border-right: 2px solid #f2c063; padding-right: 4px; animation: fadeUp 0.8s 0.3s both, typingCaret 1s infinite; min-height: 1.2em; }
        ...
        /* ==========================================================
           TOPBAR + NAV + DROPDOWN (FIXED CENTER & HOVER)
           ========================================================== */
        ...
        .menu > li:nth-child(3) { animation-delay: 0.22s; }
        .menu > li:nth-child(4) { animation-delay: 0.28s; }
        .menu > li:nth-child(5) { animation-delay: 0.34s; }
        .menu > li:nth-child(6) { animation-delay: 0.40s; }
        ...
        .mega-dropdown .dropdown-item:hover .item-text strong,
        .mega-dropdown .dropdown-item:hover .item-text span { color: #ffffff !important; }
        ...
        .hero-chip { position: absolute !important; }
        .hero-chip.c1, .news-hero .hero-chip:nth-of-type(1), .hero .hero-chip:nth-of-type(1) { top: 18% !important; right: 6% !important; left: auto !important; bottom: auto !important; }
        .hero-chip.c2, .news-hero .hero-chip:nth-of-type(2), .hero .hero-chip:nth-of-type(2) { top: auto !important; bottom: 16% !important; right: 14% !important; left: auto !important; }
        ...
        .menu a:last-child .nav-ico {
            background: linear-gradient(145deg, #e9f7ec, #d5ecdd) !important;
    ...
    <div class="container topbar-inner">
        <a href="<?= e(url('public/index.php?page=home')) ?>" class="brand">
            <?php if (!empty($s['logo_path'])): ?>
                <img class="site-logo" src="<?= e(upload_url($s['logo_path'])) ?>" alt="Logo">
            <?php endif; ?>
...
<footer class="footer">
    ...
    <div class="container" style="position: relative; z-index: 1;">
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 40px; padding: 30px 0 40px;">
            <div>
                <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 16px;">
                    <?php if (!empty($s['logo_path'])): ?>
                        <img src="<?= e(upload_url($s['logo_path'])) ?>" alt="Logo" style="height: 44px; border-radius: 12px;">
                    <?php endif; ?>
                    <span style="font-family: var(--font-display); font-weight: 800; font-size: 19px; color: #fff;">
                        <?= e($s['site_brand'] ?? 'LP3M') ?>
                    </span>
                </div>
        ...
        <div style="border-top: 1px solid rgba(255,255,255,0.1); padding: 22px 0; display: flex; align-items: center; justify-content: space-between; gap: 16px; flex-wrap: wrap;">
            <p style="font-size: 13px; color: rgba(255,255,255,0.6);"><?= $footerLine ?></p>
            <p style="font-size: 12px; color: rgba(255,255,255,0.5);">⚡ <span style="color: #f2c063; font-weight: 700;">Fastabiqul Khairat</span></p>
        </div>
    </div>
</footer>
...
(function () {
    ...
    if (socs.length && 'IntersectionObserver' in window && !reduced) {
        socs.forEach(function (s, i) { s.classList.add('soc-anim'); s.style.transitionDelay = (i * 0.09) + 's'; });
